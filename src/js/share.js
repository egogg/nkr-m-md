    ...
    "use strict";
        ...
        $.extend( Plugin.prototype, {
            ...
            shareWechat: function(obj, element) {
                ...
                qrContainer.qrcode({render : 'image', text : obj.__url, ecLevel:'H', size:210, background:'#fff'});
                var qrImg = qrContainer.find('img');

                element.bind('click', function(){
                    swal({   
                        title: '分享到微信朋友圈',   
                        text: '<img class="share-qrcode" src="' + qrImg.attr('src') + '" alt="微信分享二维码" /><div class="share-description">使用微信“扫一扫”，打开网页后点击微信屏幕右上角分享按钮分享到朋友圈</div>', 
                        html: true, 
