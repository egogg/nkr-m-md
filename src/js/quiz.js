    ...
    nkrQuiz = (function () {
        ...
        nkrQuiz.prototype.parseQuizOptionSingleSelection = function (element, quizOptions, settings) {
            ...
            for (var i = 0; i < quizOptions.length; i++) {
                ...
                quizContent += '<li class="quiz-option" data-index="' + i + '"><span class="quiz-option-tag"><em class="quiz-option-index">' + indexTag + '</em><i class="quiz-option-mark icon icon-check"></i></span><span>' + quizOptions[i].content + '</span></li>';
            };
            quizContent += '</ul></div>';
            element.append(quizContent);
